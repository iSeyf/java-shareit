...
public class ItemControllerTest {
    ...
    public void getItemsTest() throws Exception {
        ...
        when(service.getItems(anyLong())).thenReturn(items);
    ...
    public void searchItemTest() throws Exception {
        ...
        when(service.searchItem(searchText)).thenReturn(items);
    ...
    public void addCommentTest() throws Exception {
        ...
        when(service.addComment(eq(itemId), any(InputCommentDto.class), eq(userId))).thenReturn(outputCommentDto);
